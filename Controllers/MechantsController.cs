...
namespace Test13.Controllers
{
    public class MechantsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "MechantID,Pseudonyme,Image_Mechant,Disponible")] Mechant mechant)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "MechantID,Pseudonyme,Image_Mechant,Disponible")] Mechant mechant)
        {
            if (ModelState.IsValid)
            {
